...
function Header() {
    ...
    return (
        ...
        <div className='flex w-full p-6 space-x-1 items-center'>
        <Image src='https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png'  height={40}
         ...
         <from className='flex flex-grow px-6 py-3 border-gray-200 rounded-full shadow-lg max-w-3xl items-center' >
