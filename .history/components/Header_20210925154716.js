...
function Header() {
    ...
    return (
        ...
        <Image src='https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png'  height={35}
                    width={112}
         className = 'cursor-pointer '
         onClick={()=> route.push('/')}
         />

         <from className='flex flex-grow px-5 py-3 ml-10 mr-5 border-gray-200 rounded-full shadow-lg max-w-3xl items-center' >
