          ...
          {/* body */}
           ...
           <form className='flex flex-col mt-44 items-center flex-grow '>
            ...
            <div className='flex w-full mt-5 hover:shadow-lg focus-within:shadow-lg max-w-md rounded-full border border-gray-200 px-5 py-3 items-center sm:max-w-xl lg:max-w-2xl' >
             ...
             <div>
               <button className= 'p-2 mt-5  bg-[#f8f9fa]  ring-gray-200 hover:ring-1 rounded-md text-sm text-gray-900 focus:outline-none'>
                 Google Search
               </button>

               <button className='p-2 mt-5 ml-4 bg-[#f8f9fa] ring-gray-200 hover:ring-1  rounded-md text-sm text-gray-900 focus:outline-none'>
                 I'm felling lucy
               </button>
             </div>
           </form>
