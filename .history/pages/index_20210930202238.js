        ...
        <link rel="icon" href="/favicon.ico" />
         ...
         <div className='flex space-x-4 items-center' >
          ...
          {/* body */}
           ...
           <form className='flex flex-col mt-44 items-center  w-4/5'>
            <Image
            ...
            <div className='flex w-full mt-5 hover:shadow-lg focus-within:shadow-lg max-w-md rounded-full border border-gray-200 px-5 py-3 items-center sm:max-w-xl lg:max-w-2xl' >
              ...
              />
              <input className= 'focus:outline-none flex-grow' ref={searchInputRef} />

              <MicrophoneIcon className= 'h-5'/>
            </div>
             <div className='flex flex-col w-1/2 space-y-2 justify-center mt-8 sm:space-y-0 sm:flex-row sm:space-x-4'>
               <button className= 'p-3 bg-[#f8f9fa] ring-gray-200 hover:ring-1 hover:shadow-lg rounded-md text-sm text-gray-900 focus:outline-none active:ring-gray-300 ' onClick={search}>
                 Google Search
               </button>
