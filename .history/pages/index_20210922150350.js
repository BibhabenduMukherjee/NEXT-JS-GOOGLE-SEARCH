         ...
         <div className='flex space-x-4 items-center' >
          ...
          {/* body */}
           ...
           <form className='flex flex-col mt-44 items-center flex-grow '>
            ...
            <div className='flex w-full mt-5 focus-within:shadow-lg max-w-md rounded-full border border-gray-200 px-5 py-3 items-center sm:max-w-xl lg:max-w-2xl' >
              <SearchIcon
             ...
             <div>
               <button className= 'p-2 mt-5  bg-[#f8f9fa]  hover:border border-gray-300 rounded-lg text-sm text-gray-900'>
                 Google Search
               </button>

               <button className='p-2 mt-5 ml-2 bg-[#f8f9fa] hover:border border-gray-300 rounded-lg text-sm text-gray-900 '>
                 I'm felling lucy
               </button>
             </div>
           </form>
